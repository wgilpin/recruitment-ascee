...
from corporation import get_corporation_assets


@app.route('/api/corporation/<int:corporation_id>/assets', methods=['GET'])
@login_required
def api_corporation_assets(corporation_id):
    """
    Gets assets for a given corporation.
    ...
    """
    return jsonify(get_corporation_assets(corporation_id, current_user=current_user))
