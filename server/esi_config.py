...
aws_bucket_name = os.environ['AWS_BUCKET']  # 'ascendancerecruitment'
aws_region_name = os.environ['AWS_REGION']  # 'fra1'
aws_endpoint_url = os.environ['AWS_ENDPOINT_URL']  # 'https://fra1.digitaloceanspaces.com'
