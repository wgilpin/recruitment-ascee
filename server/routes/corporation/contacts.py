...
from corporation.contacts import get_corporation_contacts


@app.route('/api/corporation/<int:corporation_id>/contacts', methods=['GET'])
@login_required
def api_corporation_contacts(corporation_id):
    """
    Get contacts for a given corporation.
    ...
    """
    return jsonify(get_corporation_contacts(corporation_id, current_user=current_user))
