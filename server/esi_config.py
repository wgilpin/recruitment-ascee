...
if os.environ.get('CURRENT_ENV', '') == 'heroku':
    ...
    client_id = '055a46bfd6874a0f9de95ee89679c52f'
    secret_key = 'Ax8mA5dPDYbEibrj8cANjFtK5KQHMeNL0FEP1jLW'
    app_url = 'http://recruitment.ascendance.space/'
    database_url = 'postgres://recruitment:HarryPotter123@db:5432/recruitment'
