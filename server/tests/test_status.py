...
class ApplicantStatusTests(AsceeTestCase):
    ...
    def test_claim_applicant(self):
        response = claim_applicant(self.other_recruiter.id, self.applicant.id)
    ...
    def test_double_claim_applicant(self):
        claim_applicant(self.recruiter.id, self.applicant.id)
    ...
    def test_not_recruiter_claim_applicant(self):
        with self.assertRaises(ForbiddenException):
            claim_applicant(self.applicant.id, current_user=self.not_applicant.user)
    ...
    def test_escalate_applicant_as_non_recruiter(self):
        claim_applicant(self.applicant.id, current_user=self.recruiter.user)
        with self.assertRaises(ForbiddenException):
            escalate_applicant(self.applicant.id, current_user=self.not_applicant.user)
    ...
    def test_reject_applicant_as_non_recruiter(self):
        claim_applicant(self.applicant.id, current_user=self.recruiter.user)
        with self.assertRaises(ForbiddenException):
            reject_applicant(self.applicant.id, current_user=self.not_applicant.user)
